...
suiteSCPreprocessing = TestSuite.fromFile('structural_pipeline/test_structural_preprocessing.m', ...
    HasParameter('Name', StartsWithSubstring('SC_pre')), ...
    'ExternalParameters', paramSC);

suiteSCReconstructionDiffusion = TestSuite.fromFile('structural_pipeline/test_reconstruction_diffusion', ...
